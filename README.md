About msbuild-project-tools-server-feedstock
============================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/msbuild-project-tools-server-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/msbuild-project-tools-server-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add msbuild-project-tools-server
# for installing globally
pixi global install msbuild-project-tools-server
```
...
It is possible to list all of the versions of `msbuild-project-tools-server` available on your platform:
...
```
pixi search msbuild-project-tools-server --channel conda-forge
```
